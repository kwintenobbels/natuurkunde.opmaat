...
Wegens de definitie van de gemiddelde versnelling staan \(\vec{a}\) en \(\Delta\vec{v}\) in deze situatie in dezelfde richting en zin.
...
\begin{remark}
Een combinatie van de twee types versnelling is ook mogelijk, bijvoorbeeld bij een schuin geworpen basketbal. Ze worden dan gegeven door de vectorcomponenten van de versnelling volgens de snelheid en loodrecht op de snelheid.
\begin{image}
