...
\begin{exercise}
    ($\ast\ast\ast$) Een zieke man zit voor een raam dat \SI{1,40}{m} hoog is. Een steen wordt vanop de grond opgeworpen en passeert het raam een keer opwaarts en een keer neerwaarts. De man ziet de steen in totaal voor exact één seconde.% (Een halve bij het opgaan en een halve bij het terug naar beneden gaan.)
