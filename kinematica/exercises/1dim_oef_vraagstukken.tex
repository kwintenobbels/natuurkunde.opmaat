...
\begin{exercise}
        ...
        \SI{813}{\second} komt overeen met \(13\) minuten en \SI{33}{\second}. De trein komt aan om \(12\)u\(12\)m\(33\)s
...
\begin{exercise}
    ...
    % \end{image}
    \newline
    Als we voor $x$ de ontmoetingsplaats van \SI{400}{m} nemen, hebben we twee vergelijkingen en twee onbekenden $t$, $v_a$. Dit kunnen we oplossen door een variabele te substitueren. We nemen de tijd, $\Leftrightarrow t=\frac{x}{v_a}$ en substitueren deze in vergelijking %(\ref{verg B}):
    \begin{eqnarray*}
    x&=&x_0-2v_a(t-t_0)\\
