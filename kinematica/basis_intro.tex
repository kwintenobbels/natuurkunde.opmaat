...
In de kinematica wordt de beweging enkel \textit{beschreven}, zonder de achterliggende oorzaak te \textit{verklaren}. 


% of moleculen in water of ook in elkaar grijpende tandwieltjes in een mechanisch uurwerk. 


In dit hoofdstuk worden de \textbf{basisbegrippen} en \textbf{basisgrootheden} van de kinematica behandeld waarmee in een volgende fase enkele concrete basisbewegingen worden beschreven. (rechtlijnige, cirkelvormige, snelle, trage, versnellende en vertragende, enzovoort)

De kinematica behandelt steeds de vectoriële grootheden \textbf{positie}, \textbf{snelheid} en \textbf{versnelling}, hun verbanden onderling en hun afhankelijk met de scalaire grootheid \textbf{tijd}.
...
\begin{itemize}
	...
	\item Als de snelheid van de appel verandert, hoe groot is ze dan bij het begin van de val? En na één seconde? En wat op het moment dat de appel de grond raakt? 
\end{itemize}
