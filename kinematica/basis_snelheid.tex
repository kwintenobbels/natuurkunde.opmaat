...
Grafisch kan je de afgeleide terugvinden als de richtingscoëfficiënt van de raaklijn. In een $x-t$ grafiek (de grafiek van de functie $x(t)$, $x$ in functie van $t$) vind je de snelheid als de richtingscoëfficiënt van de raaklijn in het beschouwde punt. 
