...
\import{./lib/}{kin_theorie_I_1} % Verplaatsing en afgelegde weg

\import{./lib/}{2d_abstract_1}
\import{./lib/}{2d_abstract_I_2}

\import{./lib/}{2d_I_1} % FV 14 p. 88
\import{./lib/}{2d_I_2} % FV 6 p. 92 

\import{lib/}{dyn_ECB_I_1} % Steen aan een touwtje, middelpuntzoekende F
...
\item Een pijl, die horizontaal wordt afgeschoten in het punt P
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.8\textwidth]{afgeschotenpijl}
\end{center}
\end{figure}
\begin{oplossing}
...
\item Een puntmassa beschrijft een cirkel met een straal van $5,0\rm\,cm$ en een periode van $0,33\rm\,s$. Welke afstand op de cirkel legt deze puntmassa in $7,0\rm\,s$ af?
\begin{oplossing}
...
\item[Opgave] Bereken de hoeksnelheid van de aarde om haar as. Bereken de
