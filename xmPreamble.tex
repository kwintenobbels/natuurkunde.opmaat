...
% ================================================================================================================
%  HIER PREAMBLE VOOR TIKZPICTURES VAN TIKZ.NET 
% ================================================================================================================

\usepackage{physics}

\DeclareRobustCommand{\Tikzsource}[2]{Deze afbeelding is een afgeleid werk van \href{#1}{#2} en gelicenceerd onder \href{https://creativecommons.org/licenses/by-sa/4.0/legalcode.en}{CC BY-SA 4.0} }


% ERROR DAT \DD AL GEDEFINIEERD IS --> EEN PAKKET HIERNA 
\let\dd\relax


% dit voor rechterhandregel
...
% \usetikzlibrary{arrows.meta} % for arrow size STAAT HIERBOVEN AL 
\contourlength{0.4pt}
...
\tikzstyle{force}=[->,myred,very thick,line cap=round]
% \def\tick#1#2{\draw[thick] (#1)++(#2:0.1) --++ (#2-180:0.2)}yle{..}



% dit voor Coulombkracht 
