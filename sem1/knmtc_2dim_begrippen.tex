...
\begin{question} \end{question}
	...
	\vec{v}={d\vec{r}}{dt}&=&\lim_{\Delta t\to 0}{\vec{r}(t+\Delta t)-\vec{r}(t)}{\Delta t}\\
	&=&\lim_{\Delta t\to 0}{[x(t+\Delta t)\vec{e}_x+y(t+\Delta t)\vec{e}_y]-[x(t)\vec{e}_x+y(t)\vec{e}_y]}{\Delta t}\\
	&=&\lim_{\Delta t\to 0}{[x(t+\Delta t)-x(t)]\vec{e}_x+[y(t+\Delta t)-y(t)]\vec{e}_y}{\Delta t}\\
	&=&\lim_{\Delta t\to 0}\left({x(t+\Delta t)-x(t)}{\Delta t}\right)\vec{e}_x+\lim_{\Delta t\to 0}\left({y(t+\Delta t)-y(t)}{\Delta t}\right)\vec{e}_y\\
	&=&{dx}{dt}\vec{e}_x+{dy}{dt}\vec{e}_y%\\&=&v_x\vec{e}_x+v_y\vec{e}_y
	\end{eqnarray*}}
	\begin{eqnarray*}
	\vec{v}={d\vec{r}}{dt}={d}{dt}\left(x\cdot\vec{e}_x+y\cdot\vec{e}_y\right)={dx}{dt}\vec{e}_x+{dy}{dt}\vec{e}_y%=v_x\vec{e}_x+v_y\vec{e}_y
	\end{eqnarray*}
	...
	\begin{eqnarray*}
	\vec{v}=v_x\vec{e}_x+v_y\vec{e}_y\quad\mathrm{met}\quad v_x={dx}{dt},\,v_y={dy}{dt}
	\end{eqnarray*}
	...
	\begin{eqnarray*}
	 {dy}{dt}={dy}{dx}{dx}{dt}\Leftrightarrow{dy}{dx}={{dy}{dt}}{{dx}{dt}}={v_y}{v_x}
	\end{eqnarray*}
	Inderdaad, ${dy}{dx}$ is de helling van de baan en deze valt samen met de helling die de snelheidsvector maakt ${v_y}{v_x}$.
	\end{proof}
	...
	\begin{eqnarray*}
	\vec{a}={d\vec{v}}{dt}={dv_x}{dt}\vec{e}_x+{dv_y}{dt}\vec{e}_y=a_x\vec{e}_x+a_y\vec{e}_y
	\end{eqnarray*}
	...
	\begin{eqnarray*}
	x&=&bt\Leftrightarrow t={x}{b}\\
	&\Downarrow&\\
	y&=&c-dt^2=c-{d}{b^2}x^2
	\end{eqnarray*}
