...
%%FOTO OF AFBEELDING RONDSLINGERENDE MASSA AAN TOUW of HAMERSLINGERAAR? = in te voegen ...
...
\begin{image}[0.5\textwidth]
	\includegraphics{2_massa_ECB_met_vectoren}
\end{image}
\begin{remark}
	De versnelling in een ECB is een normale versnelling. De middelpuntzoekende kracht veroorzaakt die en dus ook de richtingsverandering van de snelheid.
\end{remark}
...
% \begin{image}[0.5\textwidth]
% 	\includegraphics{3_looping1}
% \end{image}

% \begin{image}[0.5\textwidth]
% 	\includegraphics{4_looping2}
% \end{image}
...
% \begin{image}[0.5\textwidth]
% 	\includegraphics{5_carrousel1}
% \end{image}
% \begin{image}[0.5\textwidth]
% 	\includegraphics{6_carrousel2}
% \end{image}

\end{example}

\begin{example}[Auto in een bocht op een horizontaal wegdek]
...
\begin{example}[Lorentzkracht op een bewegende lading]
