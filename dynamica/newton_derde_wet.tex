...
\begin{expandable}{remark}{De actie- en reactiekracht zijn altijd even groot, hebben dezelfde richting en tegenstelde zin.}
	Het even groot zijn van die krachten is misschien opmerkelijk. Het is toch de appel die naar de aarde valt en niet andersom?! Of, als de kracht die de aarde op de appel uitoefent even groot is als die de appel op de aarde uitoefent, waarom gaan ze dan niet naar mekaar toe? Het antwoord is dat de \emph{uitwerking} van een kracht niet hetzelfde is als de kracht zelf. De massa van de aarde is gigantisch veel groter dan die van de appel zodat die, volgens de tweede wet van Newton, een veel kleinere versnelling krijgt. En het is de versnelling die we waarnemen, niet de kracht.
\end{expandable}
...
\begin{expandable}{remark}{Actie- en reactiekracht zijn niet eenduidig.}
	Omdat de twee krachten van het krachtenpaar tegelijk optreden, is het in feite niet mogelijk aan te geven welke nu de actiekracht en welke de reactiekracht is. Het is een kip of het ei vraag, maar gelukkig is ook hier het antwoord niet relevant.
\end{expandable}

Met deze derde wet kunnen we verschillende verschijnselen verklaren. Hier volgen enkele voorbeelden.

\begin{example}[Hoe kunnen we eigenlijk stappen of lopen?] \nl
...
\begin{example}[Hoe stuwt een raket zich voort?]\nl
	Een vliegtuig met straalmotoren of een raket doen hetzelfde. Door het uitoefenen van een kracht op de naar achter uitgeworpen gassen, oefenen de uitgeworpen gassen een kracht uit op het vliegtuig of de raket, maar dan voorwaarts. (Een vliegtuig of raket duwt zich dus niet af tegen de (eventuele) stilstaande lucht.)
\end{example}
...
\begin{exercise}
	...
	\begin{oplossing}
		Het eekhoorntje moet de noten \emph{voor} zich uit gooien, in de zin van de beweging. De reactiekracht van de kracht die de eekhoorn op de nootjes uitoefent, grijpt aan op de eekhoorn en heeft een tegenstelde zin. Die reactiekracht kan hem afremmen en hem verhinderen van de tafel te glijden. Als dit nog niet voldoende zou zijn, kan het eekhoorntje ook zijn nagels in de tafel zetten om af te remmen. De nagels zetten een kracht op de tafel waardoor de tafel een weerstandskracht op de nagels zet.
	\end{oplossing}
\end{exercise}
