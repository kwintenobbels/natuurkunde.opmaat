...
\begin{exercise}
	...
	\begin{oplossing}
		De boomstammen volgen de eerste wet van Newton en zullen zonder voldoende remkracht hun beweging voortzetten (tijdens het bruusk vertragen van de vrachtwagen).
	\end{oplossing}
\end{exercise}
...
\begin{exercise}
	...
	\begin{oplossing}
		Als je de plaat snel wegtrekt, is de kleine wrijvingskracht te kortstondig aanwezig om de appel een noemenswaardige snelheid te geven. Trek je traag, dan is de wrijvingskracht en bijbehorende versnelling misschien klein, maar is ze lang genoeg aanwezig om de appel een voldoende grote snelheid te geven.
	\end{oplossing}
\end{exercise}
