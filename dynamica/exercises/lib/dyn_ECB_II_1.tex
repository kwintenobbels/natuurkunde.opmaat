...
Een massa blijft liggen op een draaitafel die met een hoeksnelheid van \SI{5,0}{rad/s} draait. Ze ligt op een afstand van \SI{10}{cm} van het middelpunt.

Hoe groot moet de wrijvingscoëfficiënt tussen de massa en de tafel minstens zijn?
\begin{image}
	\includegraphics[width=.5\linewidth]{dyn/exercises/FV6p153}
\end{image}
