...
Om een touw op de spannen moet er aan beide uiteindes een kracht gezet worden, \textbf{trekkracht} \(\vec{F}_{t}\) genaamd. 
...
Voor de eenvoud noemen we dit ook \(\vec{F}_{t}\). 
