...
\import{./lib/}{dyn_theorie_1} % Valversnelling onafh. m

\import{./lib/}{dyn_FV_9p143} % Lift en dynamometer

\import{./lib/}{dyn_I_1} % Doos en schuine kracht
\import{./lib/}{dyn_I_2} % Kracht en eindsnelheid

\import{./lib/}{dyn_II_1} % Doos op een helling
\import{./lib/}{dyn_II_2} % hockeyschijf
\import{./lib/}{dyn_II_3} % Toestel van Atwood
\import{./lib/}{dyn_II_4} % FV 6 p. 153
\import{./lib/}{dyn_II_5} % Blokken op een tafel
\import{./lib/}{dyn_II_6} % Ontsnappen langs een touw

\import{./lib/}{dyn_III_1} % Drie voorwerpen 16de VFO 2004
\import{./lib/}{dyn_III_2} % munt en blokje op een draaiende schijf

\import{./lib/}{dyn_ECB_I_1} % Steen aan een touwtje
%\import{./lib/}{dyn_ECB_II_1} % massa aan een touw in een auto in de bocht = verloren gegaan ...

\import{./lib/}{dyn_ECB_II_2} % Looping 


\import{./lib/}{dyn_ECB_theorie_I_5}
...
\item Een cirkelvormige renbaan is onder een helling van $30^\circ$
