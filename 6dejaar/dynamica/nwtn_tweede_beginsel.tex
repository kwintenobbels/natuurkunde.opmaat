...
\begin{exercise}
	...
	%\flushright
		\raisebox{1ex-\height}{%
			\includegraphics[width=\textwidth]{FV_9p143}%
			} 
	\end{minipage}
\end{exercise}
...
\begin{exercise}
	...
	\begin{minipage}[t]{.3\linewidth}
		\raisebox{1ex-\height}{%
			\includegraphics[width=\textwidth]{istockphoto-1430278348-612x612_theta}%
			} 
	\end{minipage}
...
\begin{exercise}
	...
	\begin{minipage}[t]{.37\linewidth}
		\raisebox{1ex-\height}{%
			\includegraphics[width=\textwidth]{blok_horizontvlak}} 
	\end{minipage}
