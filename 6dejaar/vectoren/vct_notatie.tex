...
Een vectoriële grootheid wordt genoteerd met \(\vec{z}, \vec{a}, \vec{x}, ...\). 
...
De pijl geeft de drie variabele kenmerken weer, evenals het aangrijpingspunt.	
...
\begin{scope}[shift={(5,0)}]
	...
	\draw[->,blue, very thick, -{latex[fill=orange]}] (A)--(E) 
		...
		node[midway, above left, blue]{\( \lvert \vec{z} \rvert \)}
