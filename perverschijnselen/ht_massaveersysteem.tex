...
\begin{document}
	...
	x(t)=A\sin(\omega t+\varphi)\quad&\mathrm{met}&\quad\omega=\sqrt{\frac{k}{m}}
	\end{eqnarray}
	We hebben nu de wiskundige oplossing van de differentiaalvergelijking gevonden. De massa trilt sinusoïdaal in de tijd. Vandaar dat we over een harmonische trilling spreken.
