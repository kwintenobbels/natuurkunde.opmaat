...
\begin{exercise}
    Een massa van \SI{200}{g} die aan het uiteinde van een horizontale opgestelde veer met veerconstante \SI{8,4}{N/m} vastzit, krijgt een tik met een hamer waardoor ze een beginsnelheid van $1,26\rm\,m/s$ heeft. Bereken% voor de beweging de periode en de amplitude.
    \begin{enumerate}
    ...
    \begin{oplossing}
        ...
        $A=v_0\sqrt{m/k}=\SI{0,194}{m}$ 

        $a_{max}=v_0\sqrt{k/m}=0,45\rm\,m/s^2$ 
        
        $E_t=1/2mv_0^2=515,97\rm\,J$
        
        $E_k=(1-0,4^2)E_t=433,41\rm\,J$ want $E_p=\frac{1}{2}k(0,4A)^2=(0,4)^2E_t$
    \end{oplossing}
\end{exercise}
